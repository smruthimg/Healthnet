...
2. Known bugs and disclaimers
	1. No validation on appointment time. You can create an appointment in the past.
3. Known missing Release-2-Beta features
	1. Some system statistics are incomplete.
